...
import { C as Connector, U as UserRejectedRequestError, a as ChainNotConfiguredError } from '../../../../dist/errors-3d8da75d.browser.esm.js';
    ...
    try {
      ...
      if (isAuthenticated) {
        return {
          ...
          account: utils.getAddress(await this.getAccount())
        };
      }
