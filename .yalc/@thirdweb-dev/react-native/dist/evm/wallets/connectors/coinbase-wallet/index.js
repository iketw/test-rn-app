...
import { UserRejectedRequestError, ChainNotConfiguredError, AddChainError, SwitchChainError, normalizeChainId, } from "@thirdweb-dev/wallets";
...
export class CoinbaseWalletConnector extends Connector {
    ...
    async getProvider() {
        if (!this.provider) {
            ...
            const chain = this.chains.find((chain_) => chain_.chainId === this.options.chainId) ||
                this.chains[0];
