...
export declare class ContractFactory extends ContractWrapper<TWFactory> {
    ...
    deploy: {
        (contractType: any, contractMetadata: any, eventEmitter: EventEmitter<DeployEvents, any>, version?: number | undefined): Promise<string>;
        prepare: (contractType: any, contractMetadata: any, eventEmitter: EventEmitter<DeployEvents, any>, version?: number | undefined) => Promise<Transaction<string>>;
    };
    deployProxyByImplementation: {
        (implementationAddress: string, implementationAbi: ContractInterface, initializerFunction: string, initializerArgs: any[], eventEmitter: EventEmitter<DeployEvents, any>): Promise<string>;
        prepare: (implementationAddress: string, implementationAbi: ContractInterface, initializerFunction: string, initializerArgs: any[], eventEmitter: EventEmitter<DeployEvents, any>) => Promise<Transaction<string>>;
    };
    /**
     *
     * @param contractType
